...
export class AdminService {
  ...
  private getUrl: string = "http://localhost:8080/api/get-admin";
  private getSaveUrl: string = "http://localhost:8080/api/save-admin";
  private deleteUrl: String = "http://localhost:8080/api/delete-admin";
